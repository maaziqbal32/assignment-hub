      ...
      >
        <div className="md:col-span-1">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-serif text-lg">Assignment Hub</span>
          </div>
        ...
        <div>
          <h4 className="text-sm font-semibold mb-4 text-accent">Services</h4>
        ...
        <div>
          <h4 className="text-sm font-semibold mb-4 text-accent">Quick Links</h4>
          <ul className="space-y-2.5 text-sm text-primary-foreground/50">
